...
(
  ...
  COLLATE = utf8mb4_general_ci COMMENT = '用户user表'
  ROW_FORMAT = DYNAMIC;
...
(
    ...
    `url`         varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '跳转详情url',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '消息日志表'
  ROW_FORMAT = DYNAMIC;
